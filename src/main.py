...
exp_id = experiment_repo.get_experiment_id_by_name_and_data_state('mpa', 'clean')           # selects the database id from the database, 
                                                                                            # that corresponds to the experiment with 'clean mpa' data  
...
meas_target = measurement_repo.get_measurement_target_by_id(1)                                          # selects a target (e.g. 'left ellbow joint angle', by the measurement id)                                                 
